...
def main():
  ...
  \fi"""
    ...
    for benchmark in benchmarks:
        ...
        ax = sns.boxplot(data=plot_data, x="type", y="time", color="white", order=unique_keys, boxprops={"fc": "w", "ec": "k"}, whiskerprops={"c": "k"}, flierprops={"mfc": "k", "mec": "k"}, medianprops={"c": "k"}, capprops={"c": "k"})
        # iterate over boxes
